...
import sys; sys.path.append("/home/ovtin/cernbox/HHggbb/HHbbgg_ETH_devel/Training/python")
...
# ---------------------------------------------------------------------------------------------------
class IO:
    ldata = os.path.expanduser("/home/ovtin/cernbox/HHggbb/HHbbgg_ETH_devel/Training/")
    xdata = "/home/ovtin/cernbox/HHggbb/HHbbgg_ETH_devel/Training/output_files/"
    plotFolder = os.path.expanduser("/home/ovtin/cernbox/HHggbb/HHbbgg_ETH_devel/Training/plots/")
    signalName = []
    backgroundName = []
    dataName = []
    sigProc = []
