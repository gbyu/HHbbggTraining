...
Float_t MVAscaling;
 ...
 if(year=="2018"){ 
   indirMVA = "/afs/cern.ch/work/i/ivovtin/public/legacy_branch_flattrees/WithBTagReweight/2018/"; 
...
//for (TString fname : {Sig}){
for (TString fname : {Bkg10,Bkg11}){
//for (TString fname : {Bkg1,Bkg2,Bkg3}){
//for (TString fname : {Bkg4,Bkg5,Bkg6,Bkg7,Bkg8,Bkg9,Data,Sig}){
