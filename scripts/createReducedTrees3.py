...
#st
loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/plots/optimization/st_MC_Bkg_lxplus/simlple_Test_binary_st.pkl'))
#st with add ptMgg
#loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/plots/optimization/st_MC_Bkg_ptmgg_lxplus/simlple_Test_binary_st.pkl'))
#st with add ptMgg+ptMjj+dR
#loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/plots/optimization/st_MC_Bkg_ptmgg_ptmjj_dR_lxplus/simlple_Test_binary_st.pkl'))
...
outTag = 'output_files'
outDir=os.path.expanduser("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/"+outTag)
...
processPath=os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.signalName[0].split("/")[len(utils.IO.signalName[0].split("/"))-1].replace("output_","").replace(".root","")+"_preselection"+".root"
postprocessing.saveTree(processPath,dictVar,nTot,Y_pred_sig)

processPath=os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.signalName[0].split("/")[len(utils.IO.signalName[0].split("/"))-1].replace("output_","").replace(".root","")+"_preselection_diffNaming"+".root"
...
processPath=(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.backgroundName[1].split("/")[len(utils.IO.backgroundName[1].split("/"))-1].replace("output_","").replace(".root","")+"_preselection"+".root").replace("_Pt-20to40","")
postprocessing.saveTree(processPath,dictVar,nTot_3,Y_pred_bkg[1])

processPath=(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.backgroundName[1].split("/")[len(utils.IO.backgroundName[1].split("/"))-1].replace("output_","").replace(".root","")+"_preselection_diffNaming"+".root").replace("_Pt-20to40","")
...
processPath=os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.dataName[0].split("/")[len(utils.IO.dataName[0].split("/"))-1].replace("output_","").replace(".root","")+"_preselection"+".root"
postprocessing.saveTree(processPath,dictVar,nTot,Y_pred_data)

processPath=os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+utils.IO.dataName[0].split("/")[len(utils.IO.dataName[0].split("/"))-1].replace("output_","").replace(".root","")+"_preselection_diffNaming"+".root"
...
print "cd "+os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag
os.system('hadd '+ os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+'Total_preselection_diffNaming.root '+ os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/')+outTag+'/'+'*diffNaming.root')
