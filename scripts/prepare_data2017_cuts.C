void prepare_data2017_cuts()
{     
      //1 change
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/DoubleEG.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_GluGluToHHTo2B2G_node_SM_13TeV-madgraph.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_GluGluHToGG_M-125_13TeV_powheg_pythia8.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_VBFHToGG_M125_13TeV_amcatnlo_pythia8.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_VBFHToGG_M-125_13TeV_powheg_pythia8.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_ttHToGG_M125_13TeV_powheg_pythia8.root";
//   TString fname = "/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_bbHToGG_M-125_4FS_yb2_13TeV_amcatnlo.root";
//   TString fname ="/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.root"; 
//   TString fname ="/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root"; 
   TString fname ="/eos/user/i/ivovtin/HHggbb/flattrees_2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root"; 
...
//   TTree *oldtree = (TTree*)dir->Get("GJet_Pt_20to40_DoubleEMEnriched_MGG_80toInf_TuneCP5_13TeV_Pythia8_13TeV_DoubleHTag_0");                                     
   ...
   //TFile newfile("small2.root", "recreate");
      ...
      //2 change
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/DoubleEG_2017_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_GluGluToHHTo2B2G_node_SM_13TeV-madgraph_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_GluGluHToGG_M-125_13TeV_powheg_pythia8_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_VBFHToGG_M125_13TeV_amcatnlo_pythia8_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_VBFHToGG_M-125_13TeV_powheg_pythia8_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_ttHToGG_M125_13TeV_powheg_pythia8_st_cuts.root","recreate");
//   TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_bbHToGG_M-125_4FS_yb2_13TeV_amcatnlo.root","recreate");
//    TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_st_cuts.root","recreate");
//    TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8_st_cuts.root","recreate");
    TFile *newfile = new TFile("/eos/user/i/ivovtin/HHggbb/HHbbgg_ETH_devel/Training/2017/flattrees_st_cuts/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8_st_cuts.root","recreate");
