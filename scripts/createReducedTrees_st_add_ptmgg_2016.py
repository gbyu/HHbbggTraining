...
#st with add ptMgg
#2016
#loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2016/st_ptmgg/simlple_Test_binary_st.pkl'))
loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2016/st_MC_Bkg_ptmgg_with_Mjj/simlple_Test_binary_st.pkl'))
###########
...
#st + pt/mgg 
#outTag = 'Hggbb/reduceTree_2016/reduceTree_st_variables_add_ptmgg_bb'
outTag = 'Hggbb/reduceTree_2016_mjj/reduceTree_st_variables_add_ptmgg_mjj'
#outTag = 'Hggbb'
