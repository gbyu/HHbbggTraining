...
#st
#2016
#loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2016/st/simlple_Test_binary_st.pkl'))
#+mjj
loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2016/st_MC_Bkg_with_Mjj/simlple_Test_binary_st.pkl'))
###########
...
import os
#st
#additionalCut_names = 'noexpand:leadingPhoton_pt/CMS_hgg_mass,noexpand:subleadingPhoton_pt/CMS_hgg_mass,MX,Mjj,CMS_hgg_mass'.split(",")
#not Mjj
additionalCut_names = 'noexpand:leadingPhoton_pt/CMS_hgg_mass,noexpand:subleadingPhoton_pt/CMS_hgg_mass,MX,CMS_hgg_mass'.split(",")
#st
#outTag = 'Hggbb/reduceTree_2016/reduceTree_st_variables_bb'
#+mjj
outTag = 'Hggbb/reduceTree_2016_mjj/reduceTree_st_variables_mjj'
