...
#st with add ptMgg
#2017
#loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2017/st_MC_Bkg_ptmgg_lxplus/simlple_Test_binary_st.pkl'))
loaded_model = joblib.load(os.path.expanduser('/eos/user/i/ivovtin/HHggbb/HHbbggTraining/Training/output_files/2017/st_MC_Bkg_ptmgg_with_Mjj/simlple_Test_binary_st.pkl'))
###########
...
#st + pt/mgg 
outTag = 'Hggbb/reduceTree_2017_mjj/reduceTree_st_variables_add_ptmgg_mjj'
#st + pt/mgg+pt/mjj+dR 
